...
const DEFAULT_FORM = {
    ...
    runtime: { account_max_inflight: 2, account_max_queue: 10, global_max_inflight: 10, token_refresh_interval_hours: 24 },
    responses: { store_ttl_seconds: 900 },
    embeddings: { provider: '' },
    auto_delete: { mode: 'none' },
    current_input_file: { enabled: true, min_chars: 0, filename_template: '' },
...
function fromServerForm(data) {
    ...
    return {
        ...
        runtime: {
            ...
            token_refresh_interval_hours: Number(data.runtime?.token_refresh_interval_hours || 24),
        },
        responses: {
